...
<div class="main" style="margin-top:150px; position:relative;">
	...
	<div class="w3-row w3-padding-64">
		<div class=" w3-container order" style="position:relative !important" id="mainorder">
			...
			<p> Your order will be delivered on the specified times </p>
			<button type="submit" onclick="location.href='home.php'" style="padding:0px 50px; font-size:120%;">Go To Home Page</button>
			<br><br>
		</div>
	</div>
</div>
