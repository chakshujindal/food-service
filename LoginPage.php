...
<div class="" style="margin-top:150px;"> <!--Put Everything in this container-->
	<div class="login"> 
		...
		<div class="loginHead w3-theme-l1">LOG-IN HERE</div> 
		<div>
		<form method="POST" action="connectivity.php"> User 
		<br>	
		<input type="text" name="user" size="40"><br> Password 
		<br>
		</div>
		<input type="password" name="pass" size="40">
		<br> <div> <input id="button" type="submit" name="submit" value="Log-In"> 
